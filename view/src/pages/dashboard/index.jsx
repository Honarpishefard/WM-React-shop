    ...
    <>
      ...
      <div className="flex flex-col items-center py-12 px-8">
        <div className="flex flex-col items-center relative">
          ...
          { user?.profilePicture ? <div className="">
            <ModalComponent classes="bg-red-700 mx-0" buttonClasses=" absolute top-2 right-0 mr-0-force"
              onClick={() =>
              ...
              submit="Yes, I'm sure" cancel="No, cancel">
