    ...
    <form className={classes}>
      <div className="flex w-full">
        ...
        <div className="relative w-full">
          <input type="search" id="search-dropdown" placeholder="Look for a product..." required
