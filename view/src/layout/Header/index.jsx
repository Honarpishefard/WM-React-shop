    ...
    <>
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                  <Link
                    to="#"
                    className="flex gap-2 items-center py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      className="w-5 h-5"
      ...
      <Navbar fluid={true} rounded={true} className="px-10">
        ...
        <Navbar.Collapse>
          ...
          <Link className="text-base text-gray-700" to="/products/women">
            {" "}
            Woman’s
          </Link>
          <Link className="text-base text-gray-700" to="#">
            {" "}
            Kid’s
          </Link>
          <Link className="text-base text-gray-700" to="#">
